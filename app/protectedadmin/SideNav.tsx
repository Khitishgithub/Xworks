...
import CreateCorporateMaster from "./CreateCorporateMaster";
import CreateCorporateUser from "./CreateCorporateUser";
...
export default function SideNav() {
  ...
  const [menuData, setMenuData] = useState("CreateWorkshops");
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
  const isMobile = useMediaQuery('(max-width:900px)');

  const menuItems = [
    { id: "CreateWorkshops", icon: PiContactlessPayment, text: "Create Workshops" },
    { id: "CreateCorporateMaster", icon: IoNotificationsSharp, text: "Create Corporate Master" },
    { id: "CreateCorporateUser", icon: PiContactlessPayment, text: "Create Corporate User" },
    { id: "GenerateCertificate", icon: PiContactlessPayment, text: "Generate Certificate" },
  ];
    ...
    <Box className="flex min-h-screen w-full overflow-x-hidden">
      ...
      >
        <motion.div
          ...
          className="w-full"
        >
          {menuData === "CreateWorkshops" && <CreateWorkshops />}
          {menuData === "CreateCorporateMaster" && <CreateCorporateMaster />}
          {menuData === "CreateCorporateUser" && <CreateCorporateUser />}
          {menuData === "GenerateCertificate" && <GenerateCertificate/>}
        </motion.div>
      </Box>
    </Box>
  );
